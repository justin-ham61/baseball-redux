...
import { faChevronLeft, faChevronDown, faAngleUp, faCircleXmark, faUser, faUsers, faUserPlus } from '@fortawesome/free-solid-svg-icons'
  ...
  return (
    <>
      ...
      <div className={showMobileMenu ? 'mobile-menu-collapsed bottom' : 'mobile-menu-collapsed top'} onClick={() => setShowMobileMenu(showMobileMenu === 0 ? 1 : 0)}>
        ...
        <motion.div
          initial={{ rotate: 0 }}
          animate={{ rotate: showMobileMenu === 1 ? 180 :  0}}
          transition={{
            duration: .3
          }}
        >
